...
int main()
{
    my_stack_double* stk_p = my_stack_double_new(5);
    my_stack_double_push(stk_p, 7);
    my_stack_double_push(stk_p, 3);
    my_stack_double_push(stk_p, 2);
    my_stack_double_swap(stk_p);
